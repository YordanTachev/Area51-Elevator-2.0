...
namespace Area_51_Take2
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int fl1 = rnd.Next(1, 5);
            int fl2 = rnd.Next(1, 5);
            int fl3 = rnd.Next(1, 5);
            int numFloors = 4;
            Elevator elevator = new Elevator(numFloors);

            Agent confidentialAgent = new Agent(SecurityLevel.Confidential, elevator, fl1);
            Agent secretAgent = new Agent(SecurityLevel.Secret, elevator, fl2);
            Agent topSecretAgent = new Agent(SecurityLevel.TopSecret, elevator, fl3);
